    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>{{ $user->name }} - IPCR - {{ strtoupper($user_type) }}</h3>
            </div>
            <div class="col-12 col-md-6 order-md-3 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        @if ($url == 'officemates')
                            <li class="breadcrumb-item active" aria-current="page"><a
                                    href="{{ route('employees') }}">Subordinates</a></li>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @if ($url != 'for-approval' || $approval->name == 'assess')
                                                                            @php
                                                                                $first = true;
                                                                            @endphp
                                                                            @foreach ($target->ratings()->where('user_id', $user->id) as $rating)
                                                                                @if ($first)
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="hstack align-items-center justify-content-center gap-2">
                                                                                                @if ($url == 'reviewing')
                                                                                                    ...
                                                                                                    @elseif (!$committee_status && $funct->id == 3 && $hr && (($score_review->designated_id && $score_review->designated_status) || (!$score_review->designated_id && $score_review->prog_chair_status)) && !$score_review->hr_status)
                                                                                                        <button type="button"
                                                                                                            class="btn icon btn-success"
                                                                                                            data-bs-toggle="modal"
                                                                                                            data-bs-target="#EditRatingModal"
                                                                                                    ...
                                                                                                    @elseif (!$committee_status && ($score_review->designated_id != auth()->user()->id && $score_review->prog_chair_id != auth()->user()->id && !$hr))
                                                                                                        <button type="button"
                                                                                                            class="btn icon btn-success"
                                                                                                            data-bs-toggle="modal"
                                                                                                            data-bs-target="#EditRatingModal"
                                                                                                ...
                                                                                                <div class="dropup-center dropup">
                                                                                                    ...
                                                                                                    <ul class="dropdown-menu p-2 border-1" style="width: 600px">
                                                                                                        <li>
                                                                                                            ...
                                                                                                            @foreach ($rating->score_logs()->where('user_id', $user->id)->get() as $score_log)
                                                                                                                <li>
                                                                                                                    <div class="row">
                                                                                                                        <div class="col-3 border-end">
                                                                                                                            <div class="row">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @if ($url != 'for-approval' || $approval->name == 'assess')
                                                                            @php
                                                                                $first = true;
                                                                            @endphp
                                                                            @foreach ($target->ratings()->where('user_id', $user->id)->get() as $rating)
                                                                                @if ($first)
                                                                                    <td>{{ $rating->accomplishment }}
                                                                                    </td>
                                                                                    <td>
