<div>
    ...
    @php
        ...
        $type = "IPCR";
    @endphp
    <x-modals :targetName="$targetName" :print="$print" :filter="$filter" :selected="$selected" :targetOutput="$targetOutput" :type="$type" :selectedTarget="$selectedTarget" :currentPage="$currentPage" :duration="$duration" :subFuncts="$subFuncts" />
</div>